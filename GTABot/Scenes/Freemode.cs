...
namespace GTABot.Scenes
{
    class Freemode : Scene
    {
        ...
        public override bool Match(ScriptBase script)
        {
            ...
            return SceneConditionHandler.HandleConditions(Settings.Instance.Data.SceneMapDictionary["freemode"], script) ||
                   SceneConditionHandler.HandleConditions(Settings.Instance.Data.SceneMapDictionary["freemode_bed"], script);
        }
